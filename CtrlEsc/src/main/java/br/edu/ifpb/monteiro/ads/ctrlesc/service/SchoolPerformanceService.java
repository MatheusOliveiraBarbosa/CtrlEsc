...
import br.edu.ifpb.monteiro.ads.ctrlesc.dao.daos.AdministratorDaoIF;
import br.edu.ifpb.monteiro.ads.ctrlesc.dao.daos.SchoolPerformanceDaoIF;
 ...
 */
@RequestScoped
public class SchoolPerformanceService implements SchoolPerformanceServiceIF{

    @Inject @SchoolPerformanceDAO
    private SchoolPerformanceDaoIF dao;
